...
\begin{document}
\pagestyle{begin}
\input{0.Inicio/1.covernewist.tex} % Uncomment for normal cover with new IST logo.
%\input{0.Inicio/1.cover.tex} % Uncomment for normal cover with IST logo.
%\input{0.Inicio/1.coveristfmul.tex} % Uncomment for Biomedical Engeneering Cover with IST and FMUL logos.
